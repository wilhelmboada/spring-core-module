...
class BookingFacadeImplTest {
    ...
    void testGetEventsByTitle() {
        ...
        verify(eventService, times(1)).getEventsByTitle(title, pageSize, pageNum);
    }
    ...
    void testGetEventsForDay() {
        ...
        assertNotNull(result);
        assertEquals(mockEvents.size(), result.size());
        verify(eventService, times(1)).getEventsForDay(day, pageSize, pageNum);
    }
    ...
    void testBookTicket() {
        ...
        verify(ticketService, times(1)).bookTicket(userId, eventId, place, category);
    }
    ...
    void testGetBookedTicketsByUser() {
        ...
        verify(ticketService, times(1)).getBookedTickets(user, pageSize, pageNum);
    }
    ...
    void testGetBookedTicketsByEvent() {
        ...
        assertNotNull(result);
        assertEquals(mockTickets.size(), result.size());
        verify(ticketService, times(1)).getBookedTickets(event, pageSize, pageNum);
    }
}
